...
| AI Preview Image Generator | zer0-mistakes | ai, images, automation, claude, openai, content | /docs/features/preview-image-generator/ |
...
| Mermaid Diagram Support | zer0-mistakes | mermaid, diagrams, visualization, documentation, accessibility, ui | /docs/features/mermaid-diagrams/ |
...
| Obsidian Graph Views (Full + Local) | zer0-mistakes | obsidian, graph, visualization, navigation | /docs/obsidian/graph/ |
...
| AI Chat Assistant (Claude or Grok + GitHub) | zer0-mistakes | ai, chatbot, claude, grok, github, proxy, accessibility | /docs/features/ai-chat-assistant/ |
...
| AI-Generated Multilingual Translations | zer0-mistakes | i18n, ai, automation, content, ui | / |
| Config-Driven Favicon and Browser Identity | zer0-mistakes | seo, branding, ui, configuration | / |
| Books Collection — Children's Picture-Book Publishing | zer0-mistakes | books, collections, layouts, storybook, ai-images, children | /books/zer0-tales/ |
| Claude Design System Round-Trip | zer0-mistakes | design-system, tokens, sass, ai, tooling | / |
| Live Design System Pages | zer0-mistakes | design-system, tokens, pages, navigation, ui | /design/ |
| Page View Counter | zer0-mistakes | analytics, privacy, engagement, metrics, ui | / |
| Cookbook & Recipes Collection | zer0-mistakes | recipes, cookbook, collections, layouts, unit-conversion, structured-data | /recipes/ |
| Visual Evidence Autogen | zer0-mistakes | ci-cd, testing, automation, ai, quality | / |
| Claude-Guided Site Builder | zer0-mistakes | ai, claude, grok, setup, onboarding, docker, proxy | /setup/ |
| Bring-Your-Own AI Provider (Claude or Grok) and Open Site Builder Sessions | zer0-mistakes | ai, claude, grok, xai, setup, onboarding, proxy, images | /setup/ |
...
Last updated: 2026-09-18T02:19:28Z